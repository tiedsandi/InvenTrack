        ...
        <AppLayout title="Master Data — Edit Produk">
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden max-w-2xl">
                <div className="px-5 py-4 border-b border-slate-100">
                    <h6 className="font-semibold text-slate-700">Form Edit Produk</h6>
                </div>
                <div className="p-5">
                    <form onSubmit={submit}>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                <label className="block text-sm font-semibold text-slate-700 mb-1">Stok <span className="text-red-500">*</span></label>
