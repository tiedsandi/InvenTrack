...
export default function Edit({ customer }) {
    ...
    const submit = (e) => { e.preventDefault(); put(`/customers/${customer.id}`); };

    return (
        <AppLayout title="Master Data — Edit Customer">
            <Head title="Edit Customer" />

            <div className="bg-white rounded-xl shadow-sm overflow-hidden max-w-xl">
                <div className="px-5 py-4 border-b border-gray-100">
                    <h6 className="font-semibold text-gray-700">Form Edit Customer</h6>
                </div>
                <div className="p-5">
                    <form onSubmit={submit}>
                        <div className="mb-4">
                            <label className="block text-sm font-semibold text-gray-700 mb-1">Nama Customer <span className="text-red-500">*</span></label>
                        ...
                        <div className="flex gap-2">
                            ...
                            <Link href="/customers" className="inline-flex items-center px-4 py-2 text-sm text-gray-600 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">Batal</Link>
                        </div>
                    </form>
                </div>
            </div>
