...
export default function Edit({ supplier }) {
    ...
    const submit = (e) => { e.preventDefault(); put(`/suppliers/${supplier.id}`); };

    return (
        <AppLayout title="Master Data — Edit Supplier">
            <Head title="Edit Supplier" />

            <div className="bg-white rounded-xl shadow-sm overflow-hidden max-w-xl">
                <div className="px-5 py-4 border-b border-gray-100">
                    <h6 className="font-semibold text-gray-700">Form Edit Supplier</h6>
                </div>
                <div className="p-5">
                    <form onSubmit={submit}>
                        ...
                        <div className="mb-4">
                            ...
                            <input type="text" value={data.phone} onChange={(e) => setData('phone', e.target.value)} className={inp(false)} />
                        </div>
                        <div className="mb-4">
