...
export default function Create() {
    ...
    const submit = (e) => { e.preventDefault(); post('/suppliers'); };

    return (
        <AppLayout title="Master Data — Tambah Supplier">
            <Head title="Tambah Supplier" />

            <div className="bg-white rounded-xl shadow-sm overflow-hidden max-w-xl">
                <div className="px-5 py-4 border-b border-gray-100">
                    <h6 className="font-semibold text-gray-700">Form Tambah Supplier</h6>
                </div>
                <div className="p-5">
                    <form onSubmit={submit}>
                        <div className="mb-4">
                            <label className="block text-sm font-semibold text-gray-700 mb-1">Nama Supplier <span className="text-red-500">*</span></label>
                        ...
                        <div className="mb-4">
                            ...
                            <input type="email" value={data.email} onChange={(e) => setData('email', e.target.value)} placeholder="email@supplier.com" className={inp(errors.email)} />
                        ...
                        <div className="flex gap-2">
                            ...
                            <Link href="/suppliers" className="inline-flex items-center px-4 py-2 text-sm text-gray-600 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">Batal</Link>
                        </div>
                    </form>
                </div>
            </div>
