        ...
        <AppLayout title="Master Data — Tambah Supplier">
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden max-w-xl">
                <div className="px-5 py-4 border-b border-slate-100">
                    <h6 className="font-semibold text-slate-700">Form Tambah Supplier</h6>
                </div>
                <div className="p-5">
                    <form onSubmit={submit}>
                        <div className="mb-4">
                            <label className="block text-sm font-semibold text-slate-700 mb-1">Nama Supplier <span className="text-red-500">*</span></label>
                        ...
                        <div className="flex gap-2">
                            ...
                            <Link href="/suppliers" className="inline-flex items-center px-4 py-2 text-sm text-slate-600 border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors">Batal</Link>
                        </div>
                    </form>
                </div>
            </div>
