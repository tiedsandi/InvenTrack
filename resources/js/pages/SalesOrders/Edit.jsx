...
export default function Edit({ salesOrder, customers, products }) {
    ...
    const submit = (e) => { e.preventDefault(); put(`/sales-orders/${salesOrder.id}`); };

    return (
        <AppLayout title="Transaksi — Edit Sales Order">
